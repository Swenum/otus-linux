...
Vagrant.configure("2") do |config|
  ...
  MACHINES.each do |boxname, boxconfig|
      ...
      config.vm.define boxname do |box|
       ...
       yum update       
	     yum install -y mdadm smartmontools hdparm gdisk wget curl iotop mc htop screen patch xz-utils kernel-devel kernel-headers gcc make dkms perl bzip2 ncurses-devel  bc bison flex elfutils-libelf-devel openssl-devel grub2
